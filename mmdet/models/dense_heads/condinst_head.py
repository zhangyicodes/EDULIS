...
class CondInstBboxHead(FCOSHead):
    ...
    def loss_by_feat(
        ...
        # print("Length of points:", len(all_level_points))
        # print("Length of regress_ranges:", len(self.regress_ranges))
        # print("Points:", all_level_points)
        # print("Regress ranges:", self.regress_ranges)
